// Generates RocketAnnouncerApp.exe — a tiny launcher that runs start.bat
...
const sedPath = join(__dirname, '_build-app.sed');
const exePath = join(__dirname, 'RocketAnnouncerApp.exe');
